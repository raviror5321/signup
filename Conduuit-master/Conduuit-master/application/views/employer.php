  ...
  <div class="main-content">
    ...
    <div class="page-content">
      <div class="page-header position-relative">
        <h1> Employer <small> <i class="icon-double-angle-right"></i> Listing </small>  </h1>
      </div>
      <!--/.page-header-->
          <!--/row-->
          <div class="row-fluid">
        ...
        <?php  foreach($rows as $v){ //print_r($v);?>
                ...
                <!--  <td><?php //echo $v['COMPANY']; ?></td>
                 ...
                 <!-- <td><?php //echo $v['CITY']; ?></td>
                  ...
                  <td>
          <a href="<?php echo base_url(); ?>Employer/leadform/<?php echo $v['ID']; ?>" class="tooltip-info blue" data-rel="tooltip" title="Edit lead type"><i class="icon-pencil bigger-130"></i></a>
