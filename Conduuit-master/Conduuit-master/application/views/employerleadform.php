  ...
  <div class="main-content">
    ...
    <div class="page-content">
      ...
      <div class="page-header position-relative">
        ...
        <h1> Employer  Info <small> <i class="icon-double-angle-right"></i> <?php echo $header['title'];?> </small></h1>
            ...
            <div class="widget-main">
              ...
              <div class="row-fluid"> 
                ...
                <div class="span12">
                  ...
                  <input  value="<?=$data['COMPANY'] ;?>" maxlength="128" class="span12" type="text"  > 
                ...
                <div class="span6">
                  ...
                  <input value="<?=$data['FIRST_NAME'] ;?>" class="span12" type="text">
                ...
                <div class="span6">
                  ...
                  <input  value="<?=$data['LAST_NAME'] ;?>" class="span12" type="text" >
              ...
              <div class="row-fluid">
                ...
                <div class="span6">
                  ...
                  <input value="<?=$data['MOBILE_NUMBER'] ;?>" class="span12" type="text" >
